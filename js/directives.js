...
angular.module('myApp.directives', ['myApp.filters'])
  ...
  .directive('myUserStatus', function ($filter, $rootScope, AppUsersManager,StatusHistory) {
      ...
      var userID,
          ...
          update = function () {
            ...
            if(user.status && (user.status._ == 'userStatusOnline' || user.status._ == 'userStatusOffline')) {
                StatusHistory.pushNewOnlineStatus(userID,user.status._ == 'userStatusOnline',tsNow(true));
            }
